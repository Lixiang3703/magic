//
//  KKCaseTrademarkListRequestModel.m
//  Magic
//
//  Created by lixiang on 15/6/27.
...
@implementation KKCaseTrademarkListRequestModel
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.modelName = kLink_WS_Model_Case_trademarkList;
    }
    return self;
}
