...
@interface KKTextToolBar() <HPGrowingTextViewDelegate>
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.textBg = [[UIImageView alloc] initWithFrame:CGRectMake(kUI_TableView_Common_Margin, kUI_TableView_Common_MarginS, self.width - 2*kUI_TableView_Common_Margin, self.height - 2 * kUI_TableView_Common_MarginS)];
